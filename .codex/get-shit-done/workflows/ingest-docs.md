...
```bash
INIT=$(node "C:/Users/abram/Projects/Abrams13F/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/abram/Projects/Abrams13F/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
